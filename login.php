...
.form-signin input[type="password"] {
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Main container area -->
      <div class="jumbotron">
        <h2>Please sign in to edit your faculty page.  If you have not created one yet, Create a new one first.</h2>
        ...
        <input type="password" name="inputPassword" class="form-control" placeholder="Password" required>
            <h6>***If you've forgotten your username and/or password please contact the webmaster. </h6>
